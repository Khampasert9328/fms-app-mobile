...
class AwaitHRLeave extends StatefulWidget {
  const AwaitHRLeave({super.key});

  @override
  State<AwaitHRLeave> createState() => _AwaitHRLeaveState();
}

class _AwaitHRLeaveState extends State<AwaitHRLeave> {
  @override
      ...
      body: ListView.builder(
        ...
        itemBuilder: ((context, index) {
          return GestureDetector(
              ...
              showDialog(
                ...
                builder: (BuildContext context) {
                  return Dialog(
                    ...
                    insetPadding: EdgeInsets.only(top: 90, bottom: 90, right: 10, left: 10),
                    child: Stack(
            ...
            child: Container(
              padding: EdgeInsets.symmetric(vertical: 7.h, horizontal: 7),
