...
class SuccessMyOT extends StatefulWidget {
  const SuccessMyOT({super.key});

  @override
  State<SuccessMyOT> createState() => _SuccessMyOTState();
}

class _SuccessMyOTState extends State<SuccessMyOT> {
  @override
  void initState() {
   context.read<ProviderService>().getovertimSuccess();
    super.initState();
  }
  @override
