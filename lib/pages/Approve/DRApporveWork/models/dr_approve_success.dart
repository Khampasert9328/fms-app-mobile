...
//
//     final drApprovedSuccessModels = drApprovedSuccessModelsFromJson(jsonString);

import 'dart:convert';

DrApprovedSuccessModels drApprovedSuccessModelsFromJson(String str) => DrApprovedSuccessModels.fromJson(json.decode(str));

String drApprovedSuccessModelsToJson(DrApprovedSuccessModels data) => json.encode(data.toJson());

class DrApprovedSuccessModels {
    int? status;
    int? total;
    List<Datum>? data;

    DrApprovedSuccessModels({
        this.status,
        this.total,
        this.data,
    });

    factory DrApprovedSuccessModels.fromJson(Map<String, dynamic> json) => DrApprovedSuccessModels(
        status: json["status"],
        total: json["total"],
