...
class DialogTMAwait extends StatefulWidget {
  DialogTMAwait({super.key});

  @override
  State<DialogTMAwait> createState() => _DialogTMAwaitState();
}

class _DialogTMAwaitState extends State<DialogTMAwait> {
  bool click = false;
            ...
            Padding(
                ...
                child: Consumer<ProviderService>(
                  builder: (context, value, child) {
                    if (value.leaveFriends == null || value.leaveFriends!.data!.isEmpty) {
                      return const Center(
                    ...
                    return Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Center(child: Text("1/${value.leaveFriends!.data?.length}")),
                            Padding(
