...
class DialogTMSuccess extends StatefulWidget {
  DialogTMSuccess({super.key});

  @override
  State<DialogTMSuccess> createState() => _DialogTMSuccessState();
}

class _DialogTMSuccessState extends State<DialogTMSuccess> {
