...
//
//     final pmModels = pmModelsFromJson(jsonString);

import 'dart:convert';

PmModels pmModelsFromJson(String str) => PmModels.fromJson(json.decode(str));

String pmModelsToJson(PmModels data) => json.encode(data.toJson());
...
class PmModels {
    ...
    factory PmModels.fromJson(Map<String, dynamic> json) => PmModels(
        status: json["status"],
