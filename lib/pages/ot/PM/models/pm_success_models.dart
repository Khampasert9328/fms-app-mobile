...
//
//     final pmSuccessModels = pmSuccessModelsFromJson(jsonString);

import 'dart:convert';

PmSuccessModels pmSuccessModelsFromJson(String str) => PmSuccessModels.fromJson(json.decode(str));

String pmSuccessModelsToJson(PmSuccessModels data) => json.encode(data.toJson());

class PmSuccessModels {
    int? status;
    List<Datum>? data;
    ...
    factory PmSuccessModels.fromJson(Map<String, dynamic> json) => PmSuccessModels(
        status: json["status"],
