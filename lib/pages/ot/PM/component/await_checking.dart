...
import 'package:fms_mobile_app/pages/ot/PM/widget/dialog/dialog_list_data.dart';
...
class PMAwaitChecking extends StatefulWidget {
  const PMAwaitChecking({super.key});

  @override
  State<PMAwaitChecking> createState() => _PMAwaitCheckingState();
}

class _PMAwaitCheckingState extends State<PMAwaitChecking> {
  @override
  void initState() {
    ...
    return Scaffold(
      body: Consumer<ProviderService>(
        builder: ((context, value, child) {
          ...
          } else if (value.pmModels == null || value.pmModels!.data!.isEmpty) {
            return Center(
              child: Column(
                                      ...
                                      onChanged: (val) {
                                        ...
                                        if (checkedIds.isEmpty) {
                                          for (var i in value.pmModels!.data!) {
                                            if (i.oStatusId == 1 ||
                                                ((i.oStatusId == 2 || i.oStatusId == -1) && i.statusApproved! > 0)) {
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  const Spacer(),
                                  if (data.oStatusId == 1 ||
                                      ((data.oStatusId == 2 || data.oStatusId == -1) && data.statusApproved! > 0) &&
                                          click == true)
