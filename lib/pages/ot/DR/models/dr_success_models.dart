...
//
//     final drSuccessModels = drSuccessModelsFromJson(jsonString);

import 'dart:convert';

DrSuccessModels drSuccessModelsFromJson(String str) => DrSuccessModels.fromJson(json.decode(str));

String drSuccessModelsToJson(DrSuccessModels data) => json.encode(data.toJson());

class DrSuccessModels {
    int? status;
    List<Datum>? data;
    ...
    factory DrSuccessModels.fromJson(Map<String, dynamic> json) => DrSuccessModels(
        status: json["status"],
