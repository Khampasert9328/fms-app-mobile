...
class OTNew extends StatefulWidget {
  const OTNew({Key? key}) : super(key: key);

  @override
  _OTNewState createState() => _OTNewState();
}

class _OTNewState extends State<OTNew> {
  bool? _loding;
  double totalh = 0.0;
                    ...
                    Container(
                      ...
                      child: Column(children: [
                        ...
                        FormHelper.dropDownWidgetWithLabel(
                            context, "ລະຫັດໜ້າວຽກ", "ເລືອກປະເພດວຽກ", workCodeId, WorkAllItemAll, (onChangedVal) {
                          setState(() {
                                ...
                                child: MyElevatedButtonPrimary(
                                  onPressed: () async {
                                    ...
                                    if (_fromDateStart != null &&
                                      ...
                                      if (totalh < 0) {
                                        _showDialogUnsuccus('ເວລາບໍຖືກຕ້ອງ');
                                      } else {
                                        _showSuccus();
                                      }
                                    } else {
