...
class DialogHR extends StatefulWidget {
  List<HRModels> models;
  DialogHR({super.key, required this.models});

  @override
  State<DialogHR> createState() => _DialogHRState();
}

class _DialogHRState extends State<DialogHR> {
  bool click = false;
