...
//
//     final listPadding = listPaddingFromJson(jsonString);

import 'dart:convert';

ListPadding listPaddingFromJson(String str) => ListPadding.fromJson(json.decode(str));

String listPaddingToJson(ListPadding data) => json.encode(data.toJson());
...
class ListPadding {
    ...
    factory ListPadding.fromJson(Map<String, dynamic> json) => ListPadding(
        status: json["status"],
