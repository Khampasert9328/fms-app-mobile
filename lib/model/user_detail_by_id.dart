...
//
//     final userDetailById = userDetailByIdFromJson(jsonString);

import 'dart:convert';

UserDetailById userDetailByIdFromJson(String str) => UserDetailById.fromJson(json.decode(str));

String userDetailByIdToJson(UserDetailById data) => json.encode(data.toJson());

class UserDetailById {
    UserDetailById({
        this.status,
        this.data,
    });
    ...
    factory UserDetailById.fromJson(Map<String, dynamic> json) => UserDetailById(
        status: json["status"],
