...
//
//     final leavesById = leavesByIdFromJson(jsonString);

import 'dart:convert';

LeavesById leavesByIdFromJson(String str) => LeavesById.fromJson(json.decode(str));

String leavesByIdToJson(LeavesById data) => json.encode(data.toJson());
...
class LeavesById {
    ...
    factory LeavesById.fromJson(Map<String, dynamic> json) => LeavesById(
        status: json["status"],
