...
//
//     final leaveAdminById = leaveAdminByIdFromJson(jsonString);

import 'dart:convert';

LeaveAdminById leaveAdminByIdFromJson(String str) => LeaveAdminById.fromJson(json.decode(str));

String leaveAdminByIdToJson(LeaveAdminById data) => json.encode(data.toJson());

class LeaveAdminById {
    LeaveAdminById({
        this.status,
        this.data,
    });
    ...
    factory LeaveAdminById.fromJson(Map<String, dynamic> json) => LeaveAdminById(
        status: json["status"],
