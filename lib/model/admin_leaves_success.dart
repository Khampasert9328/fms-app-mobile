...
//
//     final adminLeavesSuccess = adminLeavesSuccessFromJson(jsonString);

import 'dart:convert';

AdminLeavesSuccess adminLeavesSuccessFromJson(String str) => AdminLeavesSuccess.fromJson(json.decode(str));

String adminLeavesSuccessToJson(AdminLeavesSuccess data) => json.encode(data.toJson());

class AdminLeavesSuccess {
    AdminLeavesSuccess({
        this.status,
        this.data,
    });
    ...
    factory AdminLeavesSuccess.fromJson(Map<String, dynamic> json) => AdminLeavesSuccess(
        status: json["status"],
