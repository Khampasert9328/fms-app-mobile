...
TimesheetListDetial timesheetListDetialFromJson(String str) => TimesheetListDetial.fromJson(json.decode(str));

String timesheetListDetialToJson(TimesheetListDetial data) => json.encode(data.toJson());

class TimesheetListDetial {
    TimesheetListDetial({
        this.date,
    ...
    factory TimesheetListDetial.fromJson(Map<String, dynamic> json) => TimesheetListDetial(
        date: json["date"],
