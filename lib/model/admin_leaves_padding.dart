...
//
//     final adminLeavesPadding = adminLeavesPaddingFromJson(jsonString);

import 'dart:convert';

AdminLeavesPadding adminLeavesPaddingFromJson(String str) => AdminLeavesPadding.fromJson(json.decode(str));

String adminLeavesPaddingToJson(AdminLeavesPadding data) => json.encode(data.toJson());

class AdminLeavesPadding {
    AdminLeavesPadding({
        this.status,
        this.data,
    });
    ...
    factory AdminLeavesPadding.fromJson(Map<String, dynamic> json) => AdminLeavesPadding(
        status: json["status"],
